...
public class LevelRendererNeoForgeMixin {
    ...
    public void renderLevel_addSkyPass(LevelRenderer instance, FrameGraphBuilder frameGraphBuilder, CameraRenderState cameraRenderState, GpuBufferSlice gpuBufferSlice, Matrix4fc matrix) {
